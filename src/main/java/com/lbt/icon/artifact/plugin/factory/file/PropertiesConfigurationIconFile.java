 ...
 * @author johnson3yo
 */
public class PropertiesConfigurationIconFile implements IconFile {
    ...
    public File generateFile(File root, String [] titles) throws IconArtifactException {
         try {
            ...
            Writer writer = new FileWriter(new File(root.getAbsolutePath().
                    concat("/").concat("application.properties")));

            Velocity.mergeTemplate("/templates/propertiesconfig.vm", "UTF-8", context, writer);
            writer.flush();
            writer.close();
        ...
        throw new IconArtifactException("Could Not Create Properties Config File");
    }
